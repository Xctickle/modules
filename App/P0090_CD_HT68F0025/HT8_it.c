...
extern volatile uint8_t g_ucReviceStatus;
extern volatile uint8_t g_ucTimerBase1Cnt;
extern volatile uint16_t g_ucTimerBase0Cnt;
extern volatile uint16_t g_usOutPutDelay;
