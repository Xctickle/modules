...
*		V1.2    2014-12-22  armfly  增加GPIO2， GPIO0 引脚的配置。适应新版V5硬件。
*
...
#define RCC_CH_PD 		RCC_AHB1Periph_GPIOE
#define PORT_CH_PD		GPIOE
#define PIN_CH_PD		GPIO_Pin_2

#define RCC_RESET 		RCC_AHB1Periph_GPIOG
#define PORT_RESET		GPIOG
#define PIN_RESET		GPIO_Pin_15

#define RCC_GPIO2 		RCC_AHB1Periph_GPIOF
#define PORT_GPIO2		GPIOF
#define PIN_GPIO2		GPIO_Pin_6

#define RCC_GPIO0 		RCC_AHB1Periph_GPIOF
