...
*		V1.2	2014-11-29 armfly  添加单独的USART初始化函数，供应用程序切换波特率
*
...
*			  并修改 bsp_InitUartx()中的函数指针等于本函数名，比如 g_tUart3.SendBefor = USART3_SendBefor
*	形    参: 无
*	返 回 值: 无
*********************************************************************************************************
*/
...
*			  并修改 bsp_InitUartx()中的函数指针等于本函数名，比如 g_tUart3.SendOver = USART3_SendOver
*	形    参: 无
*	返 回 值: 无
*********************************************************************************************************
*/
...
*********************************************************************************************************
*	函 数 名: bsp_InitUart4
*	功能说明: 配置串口4硬件。  串口4 TX = PC10   RX = PC11
*	形    参: _uiBaud : 波特率
*	返 回 值: 无
*********************************************************************************************************
*/
...
*********************************************************************************************************
*	函 数 名: bsp_InitUart6
*	功能说明: 配置串口6硬件    PC7/USART6_RX  PG14/USART6_TX
*	形    参: _uiBaud : 波特率
*			  _HardFlowCtrl : 0表示无硬件流控， 1表示启用RTS CTS硬件流控
*	返 回 值: 无
*********************************************************************************************************
*/
void bsp_InitUart6(uint32_t _uiBaud, uint8_t _HardFlowCtrl)
{
	...
	{
		USART_InitStructure.USART_HardwareFlowControl = USART_HardwareFlowControl_None;	/* 不选择硬件流控 */
	}
	USART_InitStructure.USART_Mode = USART_Mode_Rx | USART_Mode_Tx;
